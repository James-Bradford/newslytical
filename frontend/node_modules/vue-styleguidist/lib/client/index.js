...
import renderStyleguide from './utils/renderStyleguide'; // Examples code revision to rerender only code examples (not the whole page) when code changes
...
var scrollToOrigin = function scrollToOrigin() {
  ...
  if (hasInHash(hash, '#/') || hasInHash(hash, '#!/')) {
    ...
    var idHashParam = getParameterByName(hash, 'id'); // For default scroll scrollTop is the page top
