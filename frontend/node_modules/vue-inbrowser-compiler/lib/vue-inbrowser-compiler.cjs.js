(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-inbrowser-compiler-utils'), require('buble'), require('walkes'), require('acorn')) :
    typeof define === 'function' && define.amd ? define(['exports', 'vue-inbrowser-compiler-utils', 'buble', 'walkes', 'acorn'], factory) :
    (global = global || self, factory(global.vueInbrowserCompiler = {}, global.vueInbrowserCompilerUtils, global.buble, global.walkes, global.acorn));
}(this, (function (exports, vueInbrowserCompilerUtils, buble, walkes, acorn) { 'use strict';

    walkes = walkes && walkes.hasOwnProperty('default') ? walkes['default'] : walkes;
    ...
    ***************************************************************************** */
    ...
    function compileVueCodeForEvalFunction(code, config) {
        ...
        return __assign(__assign({}, nonCompiledComponent), { script: buble.transform(nonCompiledComponent.script, config).code });
    }
